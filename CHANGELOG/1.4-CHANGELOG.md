...
The underlying API specification type has changed from an enum of type boolean to
...
* conformance: add test to check for proper cors allow-credentials behavior by @EyalPazz in https://github.com/kubernetes-sigs/gateway-api/pull/3990
